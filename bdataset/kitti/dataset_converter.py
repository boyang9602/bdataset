...
def convert_dataset(dataset_path, record_path, oxts_path='oxts.csv', lidar_sub_path='data', gnss_hz=1, warmup_time=0, allowed_msgs=None):
  ...
  kitti = KITTI(kitti_schema, allowed_msgs=allowed_msgs, warmup_time=warmup_time)
